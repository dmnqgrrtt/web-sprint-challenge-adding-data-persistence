...
Relational databases are a way to store data and SQl is a way to interact with a database

2. Why do tables need a `primary key`?

The primary key is used as a uniue identifier for each entry on a table
